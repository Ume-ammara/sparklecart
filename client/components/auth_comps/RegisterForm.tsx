...
const RegisterForm = () => {
  ...
  return (
    <>
      <Card className="w-full max-w-md overflow-hidden p-0 shadow-lg bg-card">
          ...
          >
            <div className="text-center space-y-1">
              ...
              <p className="text-muted-foreground">
                Create your Bee Kart account and enjoy seamless shopping
              </p>
            </div>
            ...
            <div className="grid gap-2">
              ...
              <div className="relative">
                ...
                <Button
                  ...
                  className="absolute right-0 top-1/2 -translate-y-1/2 bg-transparent hover:bg-transparent cursor-pointer"
                >
                  {hidePassword ? (
